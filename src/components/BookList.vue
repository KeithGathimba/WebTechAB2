...
.sort-buttons button { background: #252525; border: 1px solid #333; color: #ccc; padding: 6px 14px; border-radius: 15px; cursor: pointer; font-size: 0.85rem; transition: all 0.2s; }
.sort-buttons button:hover { background: #333; }
.sort-buttons button.active { background: #2c3e50; color: #42b983; border-color: #42b983; }
